...
def run_experiment(config_path: str | Path, output_dir: str | Path = "results/raw", overrides: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    if model_name == "isolation_forest":
        model = IsolationForestDetector(**model_cfg.get("parameters",{}))
    elif model_name == "gdn":
        from benchmark.models.gdn import GDNDetector
        model = GDNDetector(**model_cfg.get("parameters",{}))
    else:
